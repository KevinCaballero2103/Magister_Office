...
if (!isset($_GET["id"])) {
    $error = "Necesito del parámetro id para identificar al proveedor.";
} else {
    include '../db.php';
    $id = $_GET["id"];
    ...
    if ($proveedor === FALSE) {
        $error = "El proveedor indicado no existe en el sistema.";
    } else {
        ...
        // Obtener productos asociados al proveedor con precios
        $sentenciaAsociados = $conexion->prepare("
            SELECT pr.id, pr.nombre_producto, pp.precio_compra
            FROM productos pr
        ...
        $productosAsociados = $sentenciaAsociados->fetchAll(PDO::FETCH_OBJ);
    }
}

// Convertir datos para JavaScript
if (isset($proveedor)) {
    $proveedorJSON = json_encode($proveedor);
    $productosJSON = json_encode($productos);
    $productosAsociadosJSON = json_encode($productosAsociados);
} else {
    $proveedorJSON = 'null';
    $productosJSON = '[]';
    $productosAsociadosJSON = '[]';
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const proveedor = <?php echo $proveedorJSON; ?>;
            const productos = <?php echo $productosJSON; ?>;
            const productosAsociados = <?php echo $productosAsociadosJSON; ?>;
            ...
            if (proveedor === null) {
                ...
                const errorHTML = `
                    <div class='error-container'>
                        ...
                        <a href='./listado_proveedor.php' class='button'>
                            Volver al Listado
                        </a>
                    </div>
                `;
            ...
            // Inicializar productos seleccionados con los ya asociados y sus precios
            let selectedProducts = productosAsociados.map(p => ({
                id: p.id,
            ...
            const contentHTML = `
                <div class='form-container'>
                    ...
                    <form action='./editar_proveedor.php' method='post' onsubmit='return validateForm()'>
                        ...
                        <div class='columns'>
                            <div class='column is-6'>
                                <div class='field'>
                                    ...
                                    <div class='control'>
                                        <input class='input' type='text' name='nombre_proveedor' id='nombre_proveedor' 
                                ...
                                <div class='field'>
                                    ...
                                    <div class='control'>
                                        <input class='input' type='text' name='telefono_proveedor' id='telefono_proveedor' 
                                               placeholder='Ingresa el teléfono'
                                               value='${proveedor.telefono_proveedor || proveedor.telefono || ''}'>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='column is-6'>
                                <div class='field'>
                                    ...
                                    <div class='control'>
                                        <input class='input' type='text' name='direccion_proveedor' id='direccion_proveedor' 
                                    ...
                                    <div class='control'>
                                        <div class='select is-fullwidth'>
                                            <select name='estado_proveedor' id='estado_proveedor'>
                                                <option value='1' ${(proveedor.estado_proveedor == 1 || proveedor.estado == 1) ? 'selected' : ''}>Activo</option>
                                                <option value='0' ${(proveedor.estado_proveedor == 0 || proveedor.estado == 0) ? 'selected' : ''}>Inactivo</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class='button-group'>
                            ...
                            <a href='./listado_proveedor.php' class='secondary-button'>
                                Volver al Listado
                            </a>
                        </div>
                    </form>
            ...
            window.resetForm = function() {
                selectedProducts = productosAsociados.map(p => ({
                    id: p.id,
                    nombre: p.nombre_producto,
                    precio: p.precio_compra || '0.00'
                }));
