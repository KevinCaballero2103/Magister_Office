...
if (!isset($_GET["id"])) {
    ...
    try {
        ...
        if ($producto === FALSE) {
            ...
            $totalProveedor = $sentenciaProveedores->fetch(PDO::FETCH_OBJ)->total;
            ...
            if ($resultado === TRUE) {
                ...
                if ($totalProductos > 0) {
                    $mensaje = "El Producto <strong>$nombreProducto</strong> y sus <strong>$totalProveedores</strong> proveeedor(es) asociado(s) han sido eliminados exitosamente del sistema.";
                } else {
